...
class DDPG_Agent(object):
    ...
    def save(self, EnvName, episode):
        torch.save(self.actor.state_dict(), "./model/{}_actor{}k.pth".format(EnvName, int(episode / 1e3)))
        torch.save(self.q_critic.state_dict(), "./model/{}_q_critic{}k.pth".format(EnvName, int(episode / 1e3)))

    def load(self, EnvName, episode):
        self.actor.load_state_dict(torch.load("./model/{}_actor{}k.pth".format(EnvName, episode)))
        self.q_critic.load_state_dict(torch.load("./model/{}_q_critic{}k.pth".format(EnvName, episode)))
